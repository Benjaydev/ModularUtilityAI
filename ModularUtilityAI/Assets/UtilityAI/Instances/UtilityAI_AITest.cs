...
public class UtilityAI_AITest : UtilityAI
{
    ...
    public UAIBehaviour B_Eat = new UAIBehaviour("Eat", 0f, 1f, 0.3f);
    public UAIBehaviour B_Talk = new UAIBehaviour("Talk", 0f, 1f, 0.3f);
    ...
    private void OnDrawGizmos()
    {
       ...
       if(dist < 40000)
       {
           ...
           Handles.Label(pos + new Vector3(0, dimensions.y * 2, 0), "Current: " + (currentBehaviour != null ? currentBehaviour.dispalyName : "None"), guiStyle);
